...
BEGIN
    SELECT
        ...
        valid_from,
        valid_to,
        CASE WHEN valid_from <= SYSTIMESTAMP AND (valid_to IS NULL OR valid_to > SYSTIMESTAMP) THEN 1 ELSE 0 END
    INTO p_rate_id, p_rate, p_valid_from, p_valid_to, p_is_valid
    FROM exchange_rates
